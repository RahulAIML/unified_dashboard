...
/**
 * verify-multi-tenant.ts
 *
 * Verification script for multi-tenant architecture
 *
 * Usage:
 *   npx ts-node scripts/verify-multi-tenant.ts
 *
 * Checks:
 * 1. All required files exist
 * 2. Database tables have company_id columns
 * 3. Middleware validates company_id
 * 4. API endpoints use secure bridge
 * 5. Security audit logging is enabled
 */
